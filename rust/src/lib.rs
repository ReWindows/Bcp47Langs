//! Windissect-generated Rust FFI bindings for Bcp47Langs.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "5DBC5D146317FFC632245FB650DDAC78";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 4213214751;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 15] = [66, 99, 112, 52, 55, 76, 97, 110, 103, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 4213214751 { return 0; }
