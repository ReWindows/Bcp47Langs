...
static constexpr wchar_t module_name[15] = {0x0042, 0x0063, 0x0070, 0x0034, 0x0037, 0x004C, 0x0061, 0x006E, 0x0067, 0x0073, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 4213214751U || rva >= image_size) return nullptr;
return base + rva;
}
